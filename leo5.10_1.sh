...
sed -i 's/luci-app-qbittorrent//g' target/linux/rockchip/Makefile
sed -i 's/luci-app-uugamebooster//g' target/linux/rockchip/Makefile
sed -i 's/ddns-scripts_dnspod//g' target/linux/rockchip/Makefile
sed -i 's/ddns-scripts_aliyun//g' target/linux/rockchip/Makefile
sed -i 's/luci-app-xlnetacc//g' target/linux/rockchip/Makefile
sed -i 's/luci-app-unblockmusic//g' target/linux/rockchip/Makefile
sed -i 's/luci-app-ipsec-vpnd//g' target/linux/rockchip/Makefile
sed -i 's/luci-app-adbyby-plus//g' target/linux/rockchip/Makefile
